...
import 'package:task5/presentation/component/custom_icon_appbar.dart';
import 'package:task5/presentation/controller/home_cubit.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context)=>HomeCubit()..getSlider()..getCategory()..getProduct(),
                  ...
                  leading: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 5),
                        CustomIconAppBar(onTap: () {}, icon: Icons.menu),
                      ],
                    ),
                  ),
                  leadingWidth: 100,
                                        ...
                                        children: [
                                          Expanded(
                                            child: CachedNetworkImage(
                                              imageUrl:"${cubit.categoryModel![index].image}",
                                          ...
                                          Text(
                                            '${cubit.categoryModel![index].name}',
                                            style: TextStyle(
                                              fontSize: 16,
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Container(
                                  decoration: BoxDecoration(
                                      color:cubit.index ==0  ? Colors.green:Colors.grey[300],
                                      borderRadius: BorderRadius.circular(30)),
                                  child: MaterialButton(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
                                          color:cubit.index ==0  ?  Colors.white:Colors.grey),
                                    ),
                                  ),
                                ),
                              ),
                              ...
                              Expanded(
                                child: Container(
                                  decoration: BoxDecoration(
                                      color:cubit.index == 1 ? Colors.green:Colors.grey[300],
                                      borderRadius: BorderRadius.circular(30)),
                                  child: MaterialButton(
                                    onPressed: () {
                                      cubit.index =1;
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
                                          color:cubit.index ==1 ? Colors.white: Colors.grey),
                                    ),
                                  ),
                                ),
                              ),
                              ...
                              Expanded(
                                child: Container(
                                  decoration: BoxDecoration(
                                      color:cubit.index == 2?  Colors.green:Colors.grey[300],
                                      borderRadius: BorderRadius.circular(30)),
                                  child: MaterialButton(
                                    onPressed: () {
                                      cubit.index =2;
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
                                          color:cubit.index ==2 ? Colors.white:Colors.grey),
                                    ),
                                  ),
                                ),
                              ),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${cubit.productModel![index].description}',
                                        style: TextStyle(
                                          fontSize: 16,
                                        ),
